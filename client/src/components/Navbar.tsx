...
const Navbar = () => {
  ...
  return (
    <nav className=" flex -mx-5 mb-5  items-center justify-between gap-3 border-y border-gray-300 py-3 px-10">
      ...
      <ul className=" flex h-full items-center justify-center gap-3 border border-gray-300 p-[6px] pl-6 rounded-full shadow-md text-sm">
        <li className="">Anywhere</li>
        <li className=" border-l h-8 border-gray-300"></li>
        <li>Anyweek</li>
        <li className=" border-l h-8 border-gray-300"></li>
        <li className=" text-gray-400 font-light">Add guests</li>
        <li className=" p-2 bg-primary rounded-full text-white font-black">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
